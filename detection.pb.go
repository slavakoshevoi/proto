...
func (x *ImageRequest) GetImage() string {
	if x != nil {
		return x.Image
	}
	return ""
...
var file_detection_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x67, 0x72, 0x70, 0x63, 0x22, 0x24, 0x0a, 0x0c, 0x49, 0x6d, 0x61, 0x67, 0x65,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x49, 0x0a, 0x0f, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	0x74, 0x73, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x36, 0x0a, 0x06, 0x44, 0x65,
	0x74, 0x65, 0x63, 0x74, 0x12, 0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x49, 0x6d, 0x61, 0x67,
	...
	0x28, 0x01, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x3b, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f,
...
var file_detection_proto_goTypes = []interface{}{
	(*ImageRequest)(nil),   // 0: grpc.ImageRequest
	(*ResultResponse)(nil), // 1: grpc.ResultResponse
}
var file_detection_proto_depIdxs = []int32{
	0, // 0: grpc.ObjectsDetector.Detect:input_type -> grpc.ImageRequest
	1, // 1: grpc.ObjectsDetector.Detect:output_type -> grpc.ResultResponse
